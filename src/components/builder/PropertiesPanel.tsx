...
export const PropertiesPanel: React.FC = () => {
  ...
  // Handles updating section attributes or styles
    ...
    return (
      <div className="w-80 border-l border-neutral-800 bg-neutral-900 text-neutral-300 p-4 h-full flex flex-col text-sm overflow-y-auto select-none">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-neutral-400 mb-1.5">Primary Branding Brand Color</label>
            <div className="flex gap-2 items-center">
              ...
              />
              <span className="text-xs font-mono uppercase">{project.theme.colors.primary}</span>
            </div>
          </div>

          <div>
            <label className="block text-xs font-semibold text-neutral-400 mb-1.5">Secondary Interaction Accent Color</label>
            <div className="flex gap-2 items-center">
              <input
                type="color"
                ...
                className="w-8 h-8 rounded cursor-pointer bg-transparent border-0"
              />
              <span className="text-xs font-mono uppercase">{project.theme.colors.secondary}</span>
            </div>
          </div>

          <div>
            <label className="block text-xs font-semibold text-neutral-400 mb-1.5">Border Radius</label>
            <select
  ...
  return (
    <div className="w-80 border-l border-neutral-800 bg-neutral-900 text-neutral-300 p-4 h-full flex flex-col text-sm overflow-y-auto select-none">
      ...
      {selectedComponent ? (
        ...
        <div className="space-y-4">
          <div className="bg-neutral-800 p-2.5 rounded border border-neutral-700/40 text-xs">
            <span className="text-neutral-400">Selected Component: </span>
            <strong className="text-indigo-400">{selectedComponent.type}</strong>
          </div>
          ...
          {selectedComponent.type === "Heading" && (
            <>
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Heading Text</label>
                <textarea
                  value={selectedComponent.props.text || ""}
                  onChange={(e) => handlePropChange("text", e.target.value)}
                  className="w-full bg-neutral-800 border border-neutral-700 rounded p-2 text-xs text-white"
                  rows={3}
                />
              </div>

              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Semantic Level</label>
                <select
                  value={selectedComponent.props.level || "h2"}
                  onChange={(e) => handlePropChange("level", e.target.value)}
                  className="w-full bg-neutral-800 border border-neutral-700 rounded p-1.5 text-xs text-white"
                >
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Font Size</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Font Weight</label>
                <select
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Alignment</label>
                <select
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Text Color</label>
                <input
                  type="text"
          ...
          {selectedComponent.type === "Text" && (
            <>
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Body Text</label>
                <textarea
                  value={selectedComponent.props.text || ""}
                  onChange={(e) => handlePropChange("text", e.target.value)}
                  className="w-full bg-neutral-800 border border-neutral-700 rounded p-2 text-xs text-white"
          ...
          {selectedComponent.type === "Button" && (
            <>
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Link URL</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Button Variant</label>
                <select
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Background Color</label>
                <input
                  type="text"
          ...
          {selectedComponent.type === "Image" && (
            <>
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Image URL Source</label>
                <textarea
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Alt Accessibility Text</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Aspect Ratio</label>
                <select
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Fit Mode</label>
                <select
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-1">Border Radius</label>
                <input
                  type="text"
        ...
        <div className="space-y-4">
          <div className="bg-neutral-800 p-2.5 rounded border border-neutral-700/40 text-xs">
            <span className="text-neutral-400">Selected Structure: </span>
            <strong className="text-indigo-400">Section ({selectedSection.type})</strong>
          </div>

          <div>
            <label className="block text-xs font-semibold text-neutral-400 mb-1">Section Display Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-semibold text-neutral-400 mb-1">Background Fill</label>
            <div className="flex gap-2 items-center">
              <input
                type="color"
          ...
          <div>
            <label className="block text-xs font-semibold text-neutral-400 mb-1">Top Spacing (Padding)</label>
            <select
          ...
          <div>
            <label className="block text-xs font-semibold text-neutral-400 mb-1">Bottom Spacing (Padding)</label>
            <select
