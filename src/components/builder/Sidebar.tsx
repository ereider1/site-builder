...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-80 border-r border-stone-200 bg-stone-50 text-stone-700 flex flex-col h-full select-none text-sm overflow-y-auto">
      {/* 1. Page Sections Outline List */}
      <div className="p-4 border-b border-stone-200">
        <h3 className="font-semibold text-xs uppercase tracking-wider text-stone-400 mb-3 flex items-center gap-1.5">
        ...
        {activePage && activePage.sections.length > 0 ? (
              ...
              return (
                <div
                  ...
                  className={`group p-2.5 rounded-lg flex items-center justify-between cursor-pointer transition-colors ${
                    isSelected ? "bg-indigo-600 text-stone-800" : "bg-stone-50 hover:bg-stone-100"
                  }`}
                >
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      ...
                      disabled={idx === 0}
                      className="p-1 rounded text-stone-400 hover:text-stone-800 hover:bg-stone-100 disabled:opacity-30"
                    >
                    ...
                    <button
                      ...
                      className="p-1 rounded text-red-400 hover:text-red-250 hover:bg-stone-100"
                    >
          ...
          <p className="text-stone-500 text-xs italic">No sections added yet.</p>
        )}
      </div>

      {/* 2. Tailblocks-Style Visual Block Library Section */}
      <div className="p-4 border-b border-stone-200 bg-stone-50/40">
        <h3 className="font-semibold text-xs uppercase tracking-wider text-indigo-600 mb-4 flex items-center gap-1.5 select-none">
          ...
          {categories.map((category) => {
            ...
            return (
              <div key={category} className="space-y-3">
                ...
                <span className="block text-[10px] font-bold tracking-widest text-stone-500 uppercase pb-1.5 border-b border-stone-200">
                  {category}
                </span>
                ...
                <div className="space-y-3">
                  {categoryBlocks.map((block) => (
                    <div
                      ...
                      className="w-full p-2 bg-stone-50 hover:bg-stone-100 border border-stone-200/60 hover:border-stone-200 rounded-lg text-left transition-all duration-200 cursor-pointer flex flex-col gap-2 group shadow-sm select-none"
                    >
                      {/* 
                      ...
                      */}
                      <div className="w-full aspect-[16/10] bg-stone-50 border border-stone-200 rounded-md p-3.5 flex gap-3.5 overflow-hidden relative transition-colors group-hover:border-indigo-500/40 select-none">
                        ...
                        {block.id === "header-minimal" ? (
                          ...
                          <div className="w-full flex justify-between items-center py-2 px-1.5 z-10 h-full">
                            ...
                            <div className="flex gap-2.5 items-center">
                              <div className="flex gap-1.5 items-center border-r border-stone-200 pr-2.5">
                                <div className="w-3.5 h-0.75 bg-stone-700/50 rounded-full" />
                                <div className="w-3.5 h-0.75 bg-stone-700/50 rounded-full" />
                              </div>
                              <div className="w-8 h-2 bg-indigo-500/25 border border-indigo-500/10 rounded-sm shrink-0" />
                          ...
                          <div className="w-full flex gap-3.5 py-1 px-1 z-10 h-full justify-between items-center">
                            ...
                            <div className="w-5/12 aspect-square bg-white border border-stone-150 rounded-sm flex items-center justify-center relative overflow-hidden shrink-0">
                            ...
                            <div className="flex-1 grid grid-cols-2 gap-1.5 h-full">
                              {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="bg-white border border-stone-150 rounded-sm aspect-square flex items-center justify-center overflow-hidden">
                          ...
                          <div className="w-full grid grid-cols-3 gap-1.5 py-1.5 px-1 z-10 h-full items-center justify-center">
                            {[1, 2, 3, 4, 5, 6].map((i) => (
                              <div key={i} className="bg-white border border-stone-150 rounded-sm aspect-[16/10] flex items-center justify-center overflow-hidden">
                                <span className="text-[5px] text-stone-700/30">🖼</span>
                              </div>
                            ))}
                          </div>
                          ...
                          <div className="w-full flex gap-3.5 py-1 px-1 z-10 h-full justify-between items-center">
                            ...
                            <div className="w-5/12 aspect-[3/4] bg-white border border-stone-150 rounded-sm flex items-center justify-center relative overflow-hidden shrink-0">
                              <ImageIcon className="w-3 h-3 text-stone-700/35" />
                            </div>
                            {/* Right: Stacked landscape and squares */}
                            <div className="flex-1 flex flex-col gap-1.5 h-full justify-center">
                              <div className="w-full h-5 bg-white border border-stone-150 rounded-sm flex items-center justify-center overflow-hidden">
                                <span className="text-[5px] text-stone-700/30">🖼</span>
                              </div>
                              <div className="grid grid-cols-2 gap-1.5 w-full">
                                <div className="bg-white border border-stone-150 rounded-sm aspect-square flex items-center justify-center overflow-hidden">
                          ...
                          <>
                            ...
                            <div className="w-5/12 bg-white border border-stone-150 rounded flex items-center justify-center relative overflow-hidden shrink-0 z-10">
                          ...
                          <div className="w-full flex flex-col justify-between py-1 px-1.5 z-10">
                            ...
                            <div className="w-full h-8 bg-white border border-stone-150 rounded flex items-center justify-center relative overflow-hidden">
                              <div className="absolute inset-0 bg-indigo-500/5 opacity-5" />
                          ...
                          <div className="w-full flex flex-col gap-2 z-10 justify-center">
                            ...
                            <div className="w-full h-11 bg-white border border-stone-150 rounded flex items-center justify-center relative overflow-hidden shrink-0">
                              <div className="absolute inset-0 bg-indigo-500/5 opacity-5" />
                          ...
                          <div className="w-full flex flex-col justify-between py-1 z-10">
                            ...
                            <div className="space-y-1 pt-1 flex-1 flex flex-col justify-center">
                              {[1, 2, 3].map((rowIdx) => (
                                <div key={rowIdx} className="border-t border-stone-200/60 py-1.5 flex justify-between items-center w-full">
                          ...
                          <div className="w-full flex flex-col justify-between py-1 z-10">
                            ...
                            <div className="flex gap-1.5 pt-1.5">
                              {[1, 2, 3].map((cardIdx) => (
                                <div key={cardIdx} className="flex-1 bg-white border border-stone-150 p-1.5 rounded flex flex-col gap-1 shadow-sm">
                          ...
                          <div className="w-full flex flex-col justify-between py-1 px-1.5 z-10">
                            ...
                            <div className="flex gap-3 pt-2">
                              {[1, 2, 3].map((col) => (
                                <div key={col} className="flex-1 space-y-1 border-t border-stone-200/60 pt-1.5">
                          ...
                          <div className="w-full flex flex-col justify-between py-1 z-10">
                            ...
                            <div className="flex gap-2 pt-1.5">
                              {[1, 2, 3].map((idx) => (
                                <div key={idx} className="flex-1 bg-white border border-stone-150 p-1.5 rounded-sm flex flex-col gap-1 shadow-sm">
                          ...
                          <div className="w-full flex gap-3.5 py-1 items-center z-10">
                            {/* Left Image block */}
                            <div className="w-5/12 aspect-[3/4] bg-white border border-stone-150 rounded flex items-center justify-center relative overflow-hidden shrink-0">
                              <ImageIcon className="w-3.5 h-3.5 text-stone-700/35" />
                            </div>
                            {/* Right list columns */}
                            <div className="flex-1 flex flex-col gap-1">
                              ...
                              {[1, 2, 3].map((li) => (
                                <div key={li} className="border-t border-stone-200/60 py-1 space-y-0.75">
                          ...
                          <div className="w-full flex flex-col gap-1.5 py-0.5 z-10 justify-center">
                            ...
                            <div className="flex gap-3 items-center">
                              <div className="w-4/12 h-5 bg-white border border-stone-150 rounded-sm shrink-0" />
                          ...
                          <div className="w-full flex gap-2.5 py-1 z-10 justify-between items-center">
                            {/* Wide Card left */}
                            <div className="flex-1 bg-white border border-stone-150 p-2 rounded-sm flex flex-col gap-1.5 shadow-sm h-full justify-center">
                              <div className="w-8 h-0.75 bg-stone-700/50 rounded-full animate-none" />
                              <div className="w-14 h-1 bg-indigo-500/35 rounded-sm" />
                              <div className="w-full h-4 bg-stone-50 rounded-sm shrink-0 border border-stone-150" />
                            </div>
                            {/* Vertical stack right */}
                            <div className="w-4/12 flex flex-col gap-1.5 shrink-0">
                              {[1, 2].map((i) => (
                                <div key={i} className="bg-white border border-stone-150 p-1.5 rounded-sm flex flex-col gap-1 shadow-sm">
                          ...
                          <div className="w-full flex flex-col justify-between py-1 px-1.5 z-10">
                            ...
                            <div className="flex gap-2.5 pt-2">
                              {[1, 2, 3].map((col) => (
                                <div key={col} className="flex-1 space-y-1 pt-1.5 border-t border-stone-200/60">
                            ...
                            <div className="flex gap-2 pt-1.5">
                              {[1, 2, 3].map((idx) => (
                                <div key={idx} className="flex-1 flex flex-col gap-1 shadow-sm">
                                  <div className="w-full h-8 bg-white border border-stone-150 rounded-sm shrink-0 flex items-center justify-center overflow-hidden">
                          ...
                          <div className="w-full flex flex-col justify-center gap-1.5 py-1 z-10">
                            ...
                            <div className="grid grid-cols-3 gap-1.5">
                              {[1, 2, 3, 4, 5, 6].map((idx) => (
                                <div key={idx} className="bg-white border border-stone-150 p-1 rounded-sm flex flex-col gap-0.5 shadow-sm">
                          ...
                          <div className="w-full flex gap-3.5 py-1 z-10 justify-between items-start">
                            ...
                            <div className="w-5/12 flex flex-col gap-1.5 shrink-0 border-l border-stone-200/60 pl-2.5 h-full justify-center">
                              <div className="w-full h-0.5 bg-stone-800/30 rounded-full" />
                              <div className="w-11/12 h-0.5 bg-stone-800/30 rounded-full" />
                          ...
                          <div className="w-full flex gap-3.5 py-1 items-center z-10">
                            ...
                            {/* Right Image */}
                            <div className="w-4/12 aspect-[1/1] bg-white border border-stone-150 rounded flex items-center justify-center relative overflow-hidden shrink-0">
                              <ImageIcon className="w-3 h-3 text-stone-700/35" />
                            </div>
                          </div>
                          ...
                          <div className="w-full flex gap-3 py-1 items-center z-10">
                            ...
                            <div className="flex-1 space-y-1">
                              <div className="w-full h-9 bg-white border border-stone-150 rounded-sm shrink-0 flex items-center justify-center overflow-hidden">
                                <ImageIcon className="w-2.5 h-2.5 text-stone-700/30" />
                              </div>
                            ...
                            <div className="w-5/12 flex flex-col gap-1.5 shrink-0">
                              {[1, 2].map((li) => (
                                <div key={li} className="border-t border-stone-200/60 py-1 flex gap-1 items-center">
                                  <div className="w-4 h-4 bg-white border border-stone-150 rounded-sm flex items-center justify-center overflow-hidden shrink-0">
                            ...
                            <div className="flex gap-2 items-center justify-center py-1">
                              {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                                  <div className="w-5 h-5 bg-white border border-stone-150 rounded-full shrink-0" />
                          ...
                          <div className="w-full flex flex-col gap-1.5 py-1 z-10">
                            {[1, 2].map((i) => (
                              <div key={i} className="border-t border-stone-200/60 py-1 flex gap-2.5 items-start">
                                <div className="w-6 h-6 bg-white border border-stone-150 rounded-sm shrink-0" />
                            ...
                            <div className="grid grid-cols-4 gap-1.5 pt-1.5">
                              {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                                <div key={i} className="flex flex-col items-center gap-0.5">
                                  <div className="w-4.5 h-4.5 bg-white border border-stone-150 rounded-sm shrink-0" />
                          ...
                          <div className="w-full flex gap-3.5 py-1 items-center z-10 h-full">
                            {/* Large Lead left */}
                            <div className="w-5/12 aspect-[3/4] bg-white border border-stone-150 rounded flex flex-col p-1.5 gap-1 shadow-sm shrink-0 justify-center">
                              <div className="w-full h-8 bg-stone-50 rounded border border-stone-200 shrink-0" />
                            ...
                            <div className="flex-1 flex flex-col gap-1.5 shrink-0">
                              ...
                              {[1, 2, 3].map((i) => (
                                <div key={i} className="border-t border-stone-200/85 py-1 space-y-0.5">
                                  <div className="w-10 h-0.75 bg-indigo-500/35 rounded-sm" />
                          ...
                          <div className="w-full flex flex-col justify-between py-1 z-10 h-full">
                            ...
                            <div className="flex gap-3 pt-1.5">
                              {[1, 2].map((idx) => (
                                <div key={idx} className="flex-1 bg-white border border-stone-150 p-1.5 rounded flex flex-col gap-1.5 shadow-sm">
                                  <div className="space-y-0.5">
                          ...
                          <div className="w-full flex flex-col justify-between py-1 z-10 h-full">
                            ...
                            <div className="flex gap-2.5 pt-1.5">
                              {[1, 2, 3].map((idx) => (
                                <div key={idx} className="flex-1 border-t border-stone-200/60 pt-1 flex flex-col gap-1">
                                  <div className="w-full h-0.5 bg-indigo-500/30 rounded-full" />
                          ...
                          <div className="w-full flex gap-3.5 py-1 items-center z-10 h-full">
                            ...
                            {/* Right square Image */}
                            <div className="w-5/12 aspect-[1/1] bg-white border border-stone-150 rounded flex items-center justify-center relative overflow-hidden shrink-0">
                              <ImageIcon className="w-3 h-3 text-stone-700/35" />
                            </div>
                          </div>
                        ...
                        <div className="absolute inset-0 bg-indigo-600/5 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity z-20">
                          <span className="px-2 py-1 bg-indigo-600 text-stone-800 font-bold text-[10px] uppercase tracking-wider rounded shadow-md border border-indigo-500/20">
                            + Add Block
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="px-1 py-0.5 flex justify-between items-center w-full">
                        <span className="block text-stone-800 font-bold text-xs tracking-wide group-hover:text-indigo-600 transition-colors">
                          {block.name}
                        </span>
                      </div>
                    </div>
        ...
        {selectedSectionId ? (
          <div className="space-y-1.5">
            <p className="text-stone-500 text-[11px] leading-snug mb-3">
              ...
              {selectedComponentId && (
                <span className="text-indigo-600 font-semibold">(nested inside Container/Card)</span>
              )}:
            </p>
              ...
              {(["Heading", "Text", "Button", "Image", "Card", "Divider", "Spacer"] as ComponentType[]).map(
                (compType) => (
                  <button
                    ...
                    className="p-2.5 bg-stone-100 hover:bg-stone-200 border border-stone-200/30 rounded-lg text-left transition-colors font-medium text-xs truncate"
                  >
                    + {compType}
                  </button>
                )
            ...
            {selectedComponentId && (
              <div className="mt-6 p-3 bg-stone-50 border border-stone-200/40 rounded-lg">
                <p className="text-stone-400 text-xs font-semibold mb-2">Selected Component Options:</p>
                <div className="flex gap-2">
                  <button
                    onClick={() => moveComponent(selectedSectionId, selectedComponentId, "up")}
                    className="flex-1 p-2 bg-stone-100 hover:bg-stone-200 rounded text-center flex justify-center items-center gap-1 text-xs"
                  >
                  ...
                  <button
                    ...
                    className="p-2 bg-red-50 hover:bg-red-100 text-red-600 rounded flex justify-center items-center"
          ...
          <div className="p-4 bg-stone-50/30 border border-dashed border-stone-200 rounded-lg text-center">
