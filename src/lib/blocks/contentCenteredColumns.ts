...
export const createContentCenteredColumnsBlock = (): Section => {
  ...
  return {
    id: generateId("sec-content-centered"),
    name: "Content — Centered Intro + Columns",
    type: "Content",
    blockId: "content-centered-columns",
    styles: {
          ...
          // Header
          {
            ...
            children: [
              ...
              },
              {
                id: descId,
                type: "Text",
                props: { text: "Good work starts with better questions. We bring strategic clarity, curiosity, and purpose to every single challenge." },
              ...
              // Column 1
              {
                ...
                children: [
                  ...
                  },
                  {
                    id: c1TitleId,
                    type: "Heading",
                    props: { text: "Clarity", level: "h3" },
                    styles: { fontSize: "1.25rem", fontWeight: "600", color: "var(--text-color)" },
                  },
                  {
                    id: c1DescId,
                    type: "Text",
                    props: { text: "Turn complex challenges into focused plan priorities." },
              ...
              // Column 2
              {
                ...
                children: [
                  ...
                  },
                  {
                    id: c2TitleId,
                    type: "Heading",
                    props: { text: "Curiosity", level: "h3" },
                    styles: { fontSize: "1.25rem", fontWeight: "600", color: "var(--text-color)" },
                  },
                  {
                    id: c2DescId,
                    type: "Text",
                    props: { text: "Look deeper to find alternative opportunities." },
                    styles: { fontSize: "1rem", color: "var(--muted-color)", lineHeight: "1.6" },
                  },
                ],
              },
              // Column 3
              {
                ...
                children: [
                  ...
                  },
                  {
                    id: c3TitleId,
                    type: "Heading",
                    props: { text: "Purpose", level: "h3" },
                    styles: { fontSize: "1.25rem", fontWeight: "600", color: "var(--text-color)" },
                  },
                  {
                    id: c3DescId,
                    type: "Text",
                    props: { text: "Build with intention and long-term viability." },
                    styles: { fontSize: "1rem", color: "var(--muted-color)", lineHeight: "1.6" },
                  },
                ],
              },
