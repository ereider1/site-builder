...
export const createServicesEditorialListBlock = (): Section => {
  ...
  return {
    id: generateId("sec-services-list"),
    name: "Services — Editorial List",
    type: "Services",
    blockId: "services-editorial-list",
    styles: {
      background: "var(--background-color)", // Theme-neutral background
      paddingTop: "8rem",
      paddingBottom: "8rem",
    },
    contentSlots: [], // This block contains static, block-owned capabilities copy
    components: [
      {
        id: containerId,
        type: "Container",
